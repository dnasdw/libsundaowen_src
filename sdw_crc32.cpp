...
static u32 s_uCRC32LookupTable[256] =
{
...
#if 0
static const u32 s_uPolynomial = 0xEDB88320;

void GenerateCRC32LookupTable()
{
	for (u32 i = 0; i < 256; i++)
	{
		u32 uCRC32 = i;
